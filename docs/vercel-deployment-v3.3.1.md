...
참고 설정은 `infrastructure/vercel/project-settings-v3.3.1.json`에 있습니다.
...
`docs/environment-variables-v3.3.1.md`를 따릅니다. 환경변수 변경은 기존 배포에 소급 적용되지 않으므로 변경 후 재배포합니다.
...
`docs/post-deploy-smoke-test-v3.3.1.md`의 체크리스트를 사용합니다.
